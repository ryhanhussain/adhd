          ...
          <>
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                className="w-full h-12 rounded-xl bg-[var(--color-surface)] text-[var(--color-text)] font-medium text-sm flex items-center justify-center gap-3 border border-[var(--color-border)] hover:bg-[var(--color-bg)] active:scale-[0.98] transition-all duration-200"
              >
              ...
              <button
                ...
                className="w-full h-12 rounded-xl bg-[var(--color-text)] text-[var(--color-bg)] font-medium text-sm flex items-center justify-center gap-3 hover:opacity-90 active:scale-[0.98] transition-all duration-200"
              >
